...
class CaseBar(tk.Frame):
    """
    Barre de cases dynamique.
    - États possibles: 0, 1, 2 (none, side, center)
    - Clic gauche: cycle d'état
    - Clic droit: menu contextuel
    - on_change(index:int, state:str, all_states:list[str]) si fourni
    """
    DEFAULT_COLORS = (
    ...
    def _compute_layout(self):
        ...
        x = self.padding  # aligné à gauche (pas de centrage)
        y0 = self.padding//2
        y1 = H - self.padding//2
